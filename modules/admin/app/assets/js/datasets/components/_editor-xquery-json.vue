...
export default {
  ...
  methods: {
    ...
    serialize: function (mappings): string {
      let header = ["target-path", "target-node", "type", "source-node", "value"]
...
<template>
  <div class="xquery-json-editor tabular-editor">
    <div class="tabular-editor-data" v-on:keyup.esc="selected = -1">
      <div class="tabular-editor-header">
        ...
        <input readonly disabled type="text" value="type" @click="selected = -1"/>
