  ...
  def jsRoutes(): Action[AnyContent] = Action.apply { implicit request =>
    Ok(
      JavaScriptReverseRouter("datasetApi")(
        ...
        controllers.datasets.routes.javascript.UrlSetConfigs.sync,
        controllers.datasets.routes.javascript.UrlSetConfigs.get,
        controllers.datasets.routes.javascript.UrlSetConfigs.save,
        controllers.datasets.routes.javascript.UrlSetConfigs.delete,
        controllers.datasets.routes.javascript.UrlSetConfigs.test,
        controllers.datasets.routes.javascript.UrlSetConfigs.clean,
